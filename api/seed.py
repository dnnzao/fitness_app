...
def seed_exercises():
    exercise_descriptions = {
        ...
        "Posterior": {
            ...
            "Reverse Hyperextensions": "Focus on the lower back, glutes, and hamstrings. Lie face down on a hyperextension bench, secure your legs, lift your legs using your glutes and hamstrings, then lower back down to the starting position.",

            "Single-Leg Deadlifts": "Engage the hamstrings, glutes, and core. Stand on one leg, hinge at the hips to lower your body and reach towards the floor, keeping your back straight, then return to the standing position, maintaining balance.",

            "Pull Throughs": "Target the glutes, hamstrings, and lower back. Stand facing away from a cable machine, reach between your legs to grab the cable, hinge at the hips and pull the cable through your legs, extending your hips to stand up.",

            "Nordic Hamstring Curls": "Focus primarily on the hamstrings. Kneel on a pad, have someone hold your ankles or secure them under a bar, slowly lower forward keeping your hips extended, then use your hamstrings to pull back up."
        }
    }
